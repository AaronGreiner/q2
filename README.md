...
| Frontend | Sign-in, registration and password reset, the six screens plus goal detail, chat thread and settings; a global route guard; loading, empty, error and not-found states; German and English; light and dark with four device-local accent palettes ([ADR 0027](docs/adr/0027-ruhe-design-system.md)); mobile-first, developed and tested at phone width, keyboard accessible |
