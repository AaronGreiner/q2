...
| **Chats** | Three sections: your goals, friends' goals, and free conversations. Every goal has its own conversation with everybody on it, where its photographs arrive and are voted on and where each window is seen to be kept or missed; direct and group conversations are about no goal. One-tap encouragements and kudos in three registers; a reply arrives while the list or the thread is open, and any conversation can be muted — see [docs/adr/0027](docs/adr/0027-goal-conversations.md) |
