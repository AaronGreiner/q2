...
export interface paths {
    ...
    "/api/auth/token": {
        ...
        get?: never;
        put?: never;
        /** Signs in with an email address and a password, and answers with bearer tokens instead of a cookie. */
    ...
    "/api/auth/token/refresh": {
        ...
        get?: never;
        put?: never;
        /** Trades a refresh token for a new pair. Refused once the password has changed. */
    ...
    "/api/auth/password/forgot": {
        ...
        get?: never;
        put?: never;
        /** Mails a link to set a new password, if the address has an account. Answers the same either way. */
    ...
    "/api/auth/password/reset": {
        ...
        get?: never;
        put?: never;
        /** Sets a new password with the token from a reset link, and ends every session of the account. */
    ...
    "/api/invite/preview": {
        ...
        get?: never;
        put?: never;
        /** Whose link this is, and — with a session — where you stand with them. */
    ...
    "/api/invite/accept": {
        ...
        get?: never;
        put?: never;
        /** Become friends with whoever sent this link. */
...
export interface components {
    schemas: {
        ...
        InvitePreviewResponse: {
            ...
            initials: string;
            avatarColor: string;
            relation: null | components["schemas"]["FriendshipState"];
        };
        InviteResponse: {
            code: string;
        };
