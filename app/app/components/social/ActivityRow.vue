 ...
 *
 * Every line in the feed is good news, so every line can be cheered. The one
 * that was not — a friend about to miss — is a notification to that friend's
 * friends now, where there is no button to press under it
